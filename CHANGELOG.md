## [0.89.1](https://github.com/weirdtangent/pulse-os/compare/v0.89.0...v0.89.1) (2025-12-11)
...
* add pulse socket wait ([c590a5e](https://github.com/weirdtangent/pulse-os/commit/c590a5e4f951b64c106168a66905e2a5b47103b6))
...
* calendar sync service logging cleanup ([f3b5b4b](https://github.com/weirdtangent/pulse-os/commit/f3b5b4b1a28880e5fe44d2ee5b3056618838f8c7))
...
* add stale calendar sync detection ([23255b0](https://github.com/weirdtangent/pulse-os/commit/23255b01214de7c0966c6e54ca1648c782893f56))
...
* calendar sync filtering out past events ([e5a4009](https://github.com/weirdtangent/pulse-os/commit/e5a4009ed5860f6e2e629de08fc174df056346b0))
* remove non-problem logging ([f3d399b](https://github.com/weirdtangent/pulse-os/commit/f3d399b2c104e6cbaf2162e9b725de8042b5effe))

## [0.81.22](https://github.com/weirdtangent/pulse-os/compare/v0.81.21...v0.81.22) (2025-12-08)


### Bug Fixes

* add calendar sync error logging ([ee1627f](https://github.com/weirdtangent/pulse-os/commit/ee1627f0a959ffd2e2a8e8780b761ba28000f651))

## [0.81.21](https://github.com/weirdtangent/pulse-os/compare/v0.81.20...v0.81.21) (2025-12-08)


### Bug Fixes

* add calendary sync error logging ([42c7c27](https://github.com/weirdtangent/pulse-os/commit/42c7c279be75d14f772564b19277c63cdda0bed0))

## [0.81.20](https://github.com/weirdtangent/pulse-os/compare/v0.81.19...v0.81.20) (2025-12-08)


### Bug Fixes

* still trying to start over with logging ([5cc3acf](https://github.com/weirdtangent/pulse-os/commit/5cc3acf930046b5b40fde16ba0eb8436d31173f9))
...
* remove lots of useless logging ([923b658](https://github.com/weirdtangent/pulse-os/commit/923b658d9dca68c2858afd8aaa23e5d816fcde9c))
...
* calendar sync filtering out past events ([9f695f4](https://github.com/weirdtangent/pulse-os/commit/9f695f4fac27acc55d2178d8d894204199ea71cf))
...
* and more logging for calendar sync ([dc86484](https://github.com/weirdtangent/pulse-os/commit/dc86484511589a6f27416a60daf71021eae60159))

## [0.81.13](https://github.com/weirdtangent/pulse-os/compare/v0.81.12...v0.81.13) (2025-12-08)


### Bug Fixes

* and more logging for calendar sync ([d5c4615](https://github.com/weirdtangent/pulse-os/commit/d5c46156b31835de0586bad3b1d123b3437ca973))

## [0.81.12](https://github.com/weirdtangent/pulse-os/compare/v0.81.11...v0.81.12) (2025-12-08)


### Bug Fixes

* yet more logging for calendar sync ([bbf1474](https://github.com/weirdtangent/pulse-os/commit/bbf14744830a32ff03b2231c398ea0c980b20905))
...
* more logging for calendar sync filtering out past events ([af9423b](https://github.com/weirdtangent/pulse-os/commit/af9423b65d594dbdcfbcc32d73b1154d882fe410))

## [0.81.9](https://github.com/weirdtangent/pulse-os/compare/v0.81.8...v0.81.9) (2025-12-08)


### Bug Fixes

* more logging for assistant startup ([e3abbcf](https://github.com/weirdtangent/pulse-os/commit/e3abbcfb36b8264bcd0b8527509b6bc06dbf3793))

## [0.81.8](https://github.com/weirdtangent/pulse-os/compare/v0.81.7...v0.81.8) (2025-12-08)


### Bug Fixes

* more logging for assistant startup ([4595c89](https://github.com/weirdtangent/pulse-os/commit/4595c89e504a8108f0614cd9da92a19d7d911568))
...
* add stupid amount of logging for assistant startup ([c59889d](https://github.com/weirdtangent/pulse-os/commit/c59889de1232b45fe28093e541c3de109114b805))
...
* even more logging for assistant startup ([d1ad31e](https://github.com/weirdtangent/pulse-os/commit/d1ad31e57010f1ba7fea80f473e17ac9bde1a2b6))
...
* trigger overlay refresh on schedule state change ([649f77d](https://github.com/weirdtangent/pulse-os/commit/649f77de47eb75eb74da21e3498d2721b6dff621))
...
* tweaks to current weather phrase and info card ([1ba1151](https://github.com/weirdtangent/pulse-os/commit/1ba1151775ec75113520e20ec53055d82a8e7be4))
...
* work on the right buttons on the reminder card this time ([235a599](https://github.com/weirdtangent/pulse-os/commit/235a59957d5f6db4168cc7aa55b257b34e4cf150))

## [0.58.15](https://github.com/weirdtangent/pulse-os/compare/v0.58.14...v0.58.15) (2025-11-24)


### Bug Fixes

* forever, the buttons on the reminder card ([cddf03b](https://github.com/weirdtangent/pulse-os/commit/cddf03b0d0d49b01873c1d0a71ad72bf489f8eb6))
...
* for real this time, the button alignment on reminder card ([8cadd69](https://github.com/weirdtangent/pulse-os/commit/8cadd69b04322716d26db01a2915bb57f23f8834))

## [0.58.10](https://github.com/weirdtangent/pulse-os/compare/v0.58.9...v0.58.10) (2025-11-24)


### Bug Fixes

* align buttons on reminder card ([b204386](https://github.com/weirdtangent/pulse-os/commit/b2043860e4bc4d26946641fc8293ef81e3dfdb14))
...
## [0.54.7](https://github.com/weirdtangent/pulse-os/compare/v0.54.6...v0.54.7) (2025-11-24)

## [0.54.6](https://github.com/weirdtangent/pulse-os/compare/v0.54.5...v0.54.6) (2025-11-24)
...
## [0.52.6](https://github.com/weirdtangent/pulse-os/compare/v0.52.5...v0.52.6) (2025-11-23)
...
* support numeric tokens in timer start intent ([0344549](https://github.com/weirdtangent/pulse-os/commit/0344549c1a5494edc75a2a641ac461eb5091b557))
...
## [0.44.1](https://github.com/weirdtangent/pulse-os/compare/v0.44.0...v0.44.1) (2025-11-22)
...
* use accent color for now-playing window background ([afa934a](https://github.com/weirdtangent/pulse-os/commit/afa934a0e5a3da869fb82a0cb7a69bc589e8e442))
...
* update now-playing label to use [playing] prefix ([83ab889](https://github.com/weirdtangent/pulse-os/commit/83ab889b0a38a9230e3e631e56784bd8d31d1d11))
...
* fix now-playing display placement ([31046ff](https://github.com/weirdtangent/pulse-os/commit/31046ffa8f15bb843093d8ed0bf81d81dfe3e8e5))
...
* capture audio, transcribe it via the configured HA STT endpoint ([1263ab5](https://github.com/weirdtangent/pulse-os/commit/1263ab505ff8a0ab85be600f36e0449d27ba3fa6))
